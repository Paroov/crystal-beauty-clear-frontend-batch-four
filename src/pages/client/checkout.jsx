            ...
            <div className="w-[700px]">
                {
                    cart.map((item,index)=>{
                        return(
                            <div key={index} className="w-full h-[100px] bg-white shadow-2xl my-[5px] flex justify-between item-center relative">
                ...
                <div className="w-full  flex justify-end">
                    <h1 className="w-[100px] text-xl text-end pr-2">Phone No</h1>
                    <input
                     className="w-[200px] text-xl border-b-[2px] text-end pr-2"
                     value={phone}
